...
if __name__ == '__main__':
    ...
    val_dl = dataloader.fetch_dataloader(
        args.data_dir, None, args.txt_val, 'val', params)

    # Define the model
    
    model = Res_Deeplab(num_classes=params.num_classes,  layers=23).to(device)
    ...
    model = utils.load_checkpoint(model, ckpt_dir=args.checkpoint_dir, is_best=False)[0]                                
