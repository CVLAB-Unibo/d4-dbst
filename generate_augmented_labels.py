...
dataset = CS_test(root=data_dir, txt_file="/media/data_4t/aCardace/atdt/splits/cityscapes/train_random2.txt", use_depth=True, threshold=50, size=(1024, 512), label_size=(1024, 512), mean=mean, std=std, rgb=False, interpolation="lanczos")
val_dl = data.DataLoader(dataset, batch_size=4, shuffle=False, num_workers=4, pin_memory=True)

dataset1 = CS_test(root=data_dir, txt_file="/media/data_4t/aCardace/atdt/splits/cityscapes/train_random2.txt", use_depth=True, threshold=50, size=(1024, 512), label_size=(1024, 512), interpolation="lanczos")
