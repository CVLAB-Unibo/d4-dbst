...
if __name__ == '__main__':
    ...
    train_dl = dataloader.fetch_dataloader(
        args.data_dir, args.txt_train, "train", params, use_data_augmentation=True)
    ...
    model = Res_Deeplab(num_classes=params.num_classes, use_sigmoid=True, layers=6).to(params.device)
    ...
    lr_scheduler = torch.optim.lr_scheduler.OneCycleLR(
        opt, max_lr=params.learning_rate
        , steps_per_epoch=len(train_dl), epochs=params.num_epochs, div_factor=20)
