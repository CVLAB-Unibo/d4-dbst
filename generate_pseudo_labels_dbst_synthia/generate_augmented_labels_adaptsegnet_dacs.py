...
model_dir_baseline = "synthiaSEQ2CS/DA/adaptsegnet/synthia_65000.pth"
    ...
    # set model to evaluation mode
        ...
        with torch.no_grad():
            for i, (xb, yb, depth, name) in enumerate(tqdm(val_dl, position=0, leave=True)):
                ...
                name = "/data2/lDeLuigi/datasets/synthia_dbst/dacs/gtFine_adaptsegnet"
                ...
                name = name.replace('gtFine_adaptsegnet', "train_adaptsegnet")
                os.makedirs(os.path.dirname(name), exist_ok=True)
                img.save(name)
