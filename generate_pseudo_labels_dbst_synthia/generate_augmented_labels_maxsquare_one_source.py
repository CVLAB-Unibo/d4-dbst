...
val_dl = data.DataLoader(dataset, batch_size=2, shuffle=False, num_workers=4, pin_memory=True)
...
val_dl1 = data.DataLoader(dataset1, batch_size=2, shuffle=False, num_workers=4, pin_memory=True)
    ...
    # set model to evaluation mode
        ...
        with torch.no_grad():
            for i, (xb, yb, depth, name) in enumerate(tqdm(val_dl, position=0, leave=True)):
                ...
                name = "/data2/lDeLuigi/datasets/synthia_dbst/one_source_no_depth/gtFine_maxsquare"
