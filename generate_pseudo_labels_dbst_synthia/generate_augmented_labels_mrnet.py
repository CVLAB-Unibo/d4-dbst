...
# CAMBIA
model_dir_baseline = "./synthiaSEQ2cs/DA/mrnet/synthia_25000_step2.pth"
...
data_atdt/Cityscapes/dbst
                ...
                name = "/media/data_4t/aCardace/datasets/cityscapes_dbst_synthia/gtFine_mrnet"
                ...
                name = name.replace('gtFine_mrnet', "train_mrnet")
                os.makedirs(os.path.dirname(name), exist_ok=True)
                img.save(name)
                # break
