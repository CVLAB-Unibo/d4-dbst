...
model_dir_source = "synthiaSEQ2cs/net1_r50_aug"
model_dir_target = "synthiaSEQ2cs/net2_r50_wc_aug"

model_dir_transfer = "synthiaSEQ2cs/transfer"
    ...
    # set model to evaluation mode
        ...
        with torch.no_grad():
            for i, (xb, yb, depth, name) in enumerate(tqdm(val_dl, position=0, leave=True)):
                ...
                name = "/media/data_4t/aCardace/datasets/cityscapes_dbst_synthia_no_GT/gtFine_maxsquare"
