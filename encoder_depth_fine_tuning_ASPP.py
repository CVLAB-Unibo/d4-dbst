...
def train_epoch(encoder, aspp, loss_fn, dataset_dl, opt=None, lr_scheduler=None, metrics=None, params=None):
...
def train_and_evaluate(model, train_dl, val_dl1, val_dl2, opt, loss_fn, metrics, lr_scheduler, 
    ...
    for epoch in range(start_epoch, params.num_epochs):
        ...
        train_loss, train_metrics = train_epoch(
            encoder, aspp, loss_fn, train_dl, opt, lr_scheduler=lr_scheduler, metrics=metrics, params=params)
